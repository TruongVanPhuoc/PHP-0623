...
<body>
     ...
     <form class="" method="POST" action="<?= $_SERVER['PHP_SELF'].'?action=create' ?>">
            ...
            <div class="input-group mb-3">
                ...
                <input type="text" class="form-control col" name="description" placeholder=""  aria-label="Username" aria-describedby="basic-addon1">
                
                <span class="input-group-text" id="basic-addon1">Price:</span>
                <input type="text" class="form-control" name="price" placeholder=""  aria-label="Username" aria-describedby="basic-addon1">
            </div>
